...
<font style='font-size:13px'>EXISTS关字键字表示存在。在使用EXISTS关键字时，内层查询语句不返回查询的记录。
...
<img src="http://m.qpic.cn/psb?/V102A2lz4CNKDM/xsr2LLOm3uZosWdm4DQ1qkCzv95ZoLyXsqa*7A.rbco!/b/dDEBAAAAAAAA&bo=RgYiBAAAAAADB0Q!&rf=viewer_4" style="width:600px;height:450px" alt='表结构'/>

[SQL逻辑查询语句执行顺序](href "http://www.cnblogs.com/linhaifeng/articles/7372774.html")
